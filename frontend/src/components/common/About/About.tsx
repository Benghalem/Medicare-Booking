  ...
  return (
    <section>
      <div className="container">
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col sm:flex-row">
          {/* ========= about image =========== */}
          ...
          <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            ...
            <p className="text__para mt-[30px]">
              ...
              possimus nihil maxime molestias illum laborum provident,
              laboriosam cumque aspernatur molestiae fuga culpa, quod quo quasi,
              totam natus suscipit veniam distinctio!
            </p>
            <Link to="/">
